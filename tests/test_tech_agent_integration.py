...
def test_tech_agent_basic_flow(client):
    ...
    print(f"\n✅ 測試通過！")
    print(f"外層回應: status={response_data['status']}, message={response_data['message']}")
    print(f"內層數據: status={data['status']}, message={data['message']}, render_type={first_render['type']}")
